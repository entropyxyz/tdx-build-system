...
;; Guix commit 993d6d2e7be4dac738629c76a51058f4dc5bc449
;; TODO: Cleanup openssl inputs
(define-module (teeeee packages threshold-signature-service)
  #:use-module (guix)
  ...
  (package
    ...
    (source
     (origin
       ...
       (patches (list "/home/dd/src/@poetic-technologies/entropy-ci/rust-rlp-add-derive-feature.patch"))))
    (build-system cargo-build-system)
    (arguments
     `(#:skip-build? #t
       #:features '("derive")
...
(define-public rust-entropy-tss-0.2
  (package
    (name "rust-entropy-tss")
    (version "0.2.0")
    (source
     (origin
       (method url-fetch)
